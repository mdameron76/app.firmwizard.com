                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-5 mb-4 flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="avatar avatar-md avatar-rounded me-1"><img src="{{asset('build/assets/images/faces/11.jpg')}}" alt=""></span>
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <p class="project-activity-media mb-0">
                                                    <a href="javascript:void(0);">
                                                        <img src="{{asset('build/assets/images/media/file-manager/3.png')}}" alt="" class="img-fluid bg-light">
                                                    </a>  
