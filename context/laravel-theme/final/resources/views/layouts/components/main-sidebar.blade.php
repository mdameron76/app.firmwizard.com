						...
						<ul class="main-menu">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="{{url('index1')}}" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('index2')}}" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="{{url('customers-list')}}" class="side-menu__item">Customers</a>
											</li>
											<li class="slide">
												<a href="{{url('orders')}}" class="side-menu__item">Orders</a>
											</li>
											<li class="slide">
												<a href="{{url('orders-details')}}" class="side-menu__item">Order Details</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('index4')}}" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
												<a href="{{url('crypto-transactions')}}" class="side-menu__item">Transactions</a>
											</li>
											<li class="slide">
												<a href="{{url('crypto-currency-exchange')}}" class="side-menu__item">Exchange</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('index3')}}" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('index6')}}" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="{{url('index8')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('index9')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('index10')}}" class="side-menu__item">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('index5')}}" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('index7')}}" class="side-menu__item">Dashboard</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="{{url('jobs-list')}}" class="side-menu__item">Jobs List</a>
											</li>
											<li class="slide">
									...
									<li class="slide">
										<a href="{{url('index13')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('index15')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('index14')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('index11')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('index12')}}" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="{{url('chat')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('file-manager')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('full-calendar')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('gallery')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('sweet-alerts')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('to-do-list')}}" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1 pages-ul">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide has-sub">
												...
												<ul class="slide-menu child3">
													<li class="slide">
														<a href="{{url('two-step-verification-basic')}}" class="side-menu__item">Basic</a>
													</li>
													<li class="slide">
														<a href="{{url('two-step-verification-cover')}}" class="side-menu__item">Cover</a>
													</li>
												</ul>
											</li> 
											<li class="slide">
									...
									<li class="slide">
										<a href="{{url('emptypage')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('pricing')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('profile')}}" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><path d="M128,32A96,96,0,0,0,63.8,199.38h0A72,72,0,0,1,128,160a40,40,0,1,1,40-40,40,40,0,0,1-40,40,72,72,0,0,1,64.2,39.37A96,96,0,0,0,128,32Z" opacity="0.2"/><path d="M63.8,199.37a72,72,0,0,1,128.4,0" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="128" r="96" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="120" r="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Profile</a>
									</li>
									<li class="slide">
									...
									<li class="slide">
										<a href="{{url('testimonials')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('search-results')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('team')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('terms-conditions')}}" class="side-menu__item">
											<svg xmlns="http://www.w3.org/2000/svg" class="side-menu-doublemenu__icon" viewBox="0 0 256 256"><rect width="256" height="256" fill="none"/><polygon points="152 32 152 88 208 88 152 32" opacity="0.2"/><path d="M200,224H56a8,8,0,0,1-8-8V40a8,8,0,0,1,8-8h96l56,56V216A8,8,0,0,1,200,224Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><polyline points="152 32 152 88 208 88" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="136" x2="160" y2="136" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><line x1="96" y1="168" x2="160" y2="168" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
											Terms & Conditions</a>
									</li>
									<li class="slide">
										<a href="{{url('timeline')}}" class="side-menu__item">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide">
												<a href="{{url('buttongroup')}}" class="side-menu__item">Button Group</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											...
											<li class="slide">
												<a href="{{url('css-grid')}}" class="side-menu__item">Css Grid</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="{{url('position')}}" class="side-menu__item">Position</a>
											</li>
											<li class="slide">
									...
									<li class="slide has-sub">
										...
										<ul class="slide-menu child2">
											<li class="slide">
												<a href="{{url('accordions-collpase')}}" class="side-menu__item">Accordions & Collapse</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="{{url('media-player')}}" class="side-menu__item">Media Player</a>
											</li>
											<li class="slide">
											...
											<li class="slide">
												<a href="{{url('tour')}}" class="side-menu__item">Tour</a>
											</li>
										</ul>
									</li>
								</ul>
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="{{url('vector-maps')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('leaflet-maps')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('google-maps')}}" class="side-menu__item">
							...
							<li class="slide has-sub">
								...
								<ul class="slide-menu child1">
									...
									<li class="slide">
										<a href="{{url('chartjs-charts')}}" class="side-menu__item">
									...
									<li class="slide">
										<a href="{{url('echarts')}}" class="side-menu__item">
