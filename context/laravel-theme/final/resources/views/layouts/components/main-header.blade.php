							...
							<div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
								<div class="p-3 bg-primary text-fixed-white">
									<div class="d-flex align-items-center justify-content-between">
										...
										<a href="{{url('products')}}" class="text-fixed-white text-decoration-underline fs-12">Continue Shopping <i class="ti ti-arrow-narrow-right"></i></a>
									</div>
								</div>
												...
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="{{url('cart')}}">Urban Chic Satchel</a>
														</div>
										...
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											...
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="{{url('cart')}}">TrailBlaze Runners</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
										...
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											...
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="{{url('cart')}}">VisionTech SLR</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
										...
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											...
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="{{url('cart')}}">FlexiSeat Office Chair</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
										...
										<div class="d-flex align-items-start cart-dropdown-item gap-3">
											...
											<div class="flex-fill w-75">
												<div class="d-flex align-items-start justify-content-between mb-3">
													<div class="fs-14 fw-medium w-75">
														<div class="text-truncate">
															<a href="{{url('cart')}}">DecoDial Classic</a>
														</div>
														<div class="fs-11 text-muted text-truncate">
								...
								<div class="p-3 empty-header-item border-top">
									<div class="text-center d-grid">
										<a href="{{url('checkout')}}" class="btn btn-primary btn-wave">Proceed to checkout</a>
									</div>
								</div>
								...
								<ul class="list-unstyled mb-0">
									<li>
										<ul class="list-unstyled mb-0 sub-list">
											<li>
												<a class="dropdown-item d-flex align-items-center" href="{{url('profile')}}"><i class="ti ti-user-circle me-2 fs-18"></i>View Profile</a>
											</li>
											<li>
												<a class="dropdown-item d-flex align-items-center" href="{{url('mail-settings')}}"><i class="ti ti-settings-cog me-2 fs-18"></i>Account Settings</a>
											</li>
										</ul>        
									</li>
									<li>
									...
									<li><a class="dropdown-item d-flex align-items-center" href="{{url('sign-in-cover')}}"><i class="ti ti-logout me-2 fs-18"></i>Log Out</a></li>
								</ul>
							</div>
						</li>  
						<!-- End::header-element -->
